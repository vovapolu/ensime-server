...
class DocResolverSpec extends FlatSpec with Matchers with SLF4JLogging
  ...
  "DocResolver" should "support a wide range of queries" in withEnsimeConfig { implicit c =>
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@map[B](f:A=>B):Option[B]")
    ...
    )) shouldBe Some("guava-18.0-javadoc.jar/com/google/common/io/Files.html#simplifyPath(java.lang.String)")

    serv.resolve(DocSigPair(
      DocSig(DocFqn("scala", "Boolean"), None),
      DocSig(DocFqn("", "boolean"), None)
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Boolean")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Option@isDefined:Boolean")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@flatMap[B](f:A=>Option[B]):Option[B]")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@flatten[B](implicitev:<:<[A,Option[B]]):Option[B]")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@fold[B](ifEmpty:=>B)(f:A=>B):B")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@mkString(start:String,sep:String,end:String):String")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@mkString:String")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@mkString(sep:String):String")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@getOrElse[B>:A](default:=>B):B")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@grouped(size:Int):Iterator[Repr]")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.collection.immutable.List$@empty[A]:List[A]")
    ...
    )) shouldBe Some("guava-18.0-javadoc.jar/com/google/common/io/Files.html#move(java.io.File, java.io.File)")
    ...
    )) shouldBe Some("guava-18.0-javadoc.jar/com/google/common/io/Files.html#asByteSource(java.io.File)")
    ...
    )) shouldBe Some("guava-18.0-javadoc.jar/com/google/common/io/Files.html#map(java.io.File, java.nio.channels.FileChannel.MapMode)")
    ...
    )) shouldBe Some("guava-18.0-javadoc.jar/com/google/common/io/Files.html#map(java.io.File, java.nio.channels.FileChannel.MapMode, long)")
    ...
    )) shouldBe Some("guava-18.0-javadoc.jar/com/google/common/io/Files.html#write(byte[], java.io.File)")
    ...
    serv.resolve(DocSigPair(
      ...
      DocSig(DocFqn("scala", "Some"), None)
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Int")
    ...
    serv.resolve(DocSigPair(
      ...
      DocSig(DocFqn("scala", "Predef.DummyImplicit"), None)
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Predef$$DummyImplicit$")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.package@Exception=Exception")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.Some@++[B](that:scala.collection.GenTraversableOnce[B]):Option[B]")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.collection.immutable.List@flatMap[B](f:A=>scala.collection.GenTraversableOnce[B]):List[B]")
    ...
    )) shouldBe Some("scala-library-" + c.scalaVersion + "-javadoc.jar/index.html#scala.collection.immutable.List@collect[B](pf:PartialFunction[A,B]):List[B]")
  ...
  it should "support Java 6 online docs" in withEnsimeConfig { implicit config =>
    val serv = new DocResolver(Some("1.6"))
  ...
  it should "support Java 8 docs" in withEnsimeConfig { implicit config =>
    val serv = new DocResolver(Some("1.8"))
    ...
    ) shouldBe Some("ForecastIOLib-1.5.1-javadoc.jar/com/github/dvdme/ForecastIOLib/ForecastIO.html#getForecast-com.eclipsesource.json.JsonObject-")
