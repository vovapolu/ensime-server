  ...
  describe("Server") {
    it("should open the test project", SlowTest) {
      ...
      IntgUtil.withTestProject("src/example-simple") { (config, interactor) =>
        ...
        // typecheck
        interactor.expectRPC(20 seconds, """(swank:typecheck-file """ + fooFile + ")",
          """(:ok t)""")
        ...
        assert(
          symbolDesignationsRes == """(:ok (:file """ + fooFile + """ :syms ((package 12 19) (package 8 11) (trait 40 43) (valField 69 70) (class 100 103) (param 125 126) (class 128 131) (param 133 134) (class 136 142) (operator 156 157) (param 154 155) (functionCall 160 166) (param 158 159) (valField 183 186) (valField 189 192) (class 193 199) (class 201 204) (valField 214 217) (class 224 227) (functionCall 232 239) (operator 250 251) (valField 256 257) (valField 252 255) (functionCall 261 268) (functionCall 273 283) (valField 269 272))))""" ||
            symbolDesignationsRes == """(:ok (:file """ + fooFile + """ :syms ((package 12 19) (package 8 11) (trait 40 43) (valField 69 70) (class 100 103) (param 125 126) (class 128 131) (param 133 134) (class 136 142) (operator 156 157) (param 154 155) (functionCall 160 166) (param 158 159) (valField 183 186) (class 193 199) (class 201 204) (valField 214 217) (class 224 227) (functionCall 232 239) (operator 250 251) (valField 256 257) (valField 252 255) (functionCall 261 268) (functionCall 273 283) (valField 269 272))))""",
          symbolDesignationsRes
        )
        ...
        val inspectResp = interactor.sendRPCExp(20 seconds, SExpParser.read(
          """(swank:symbol-at-point """ + fooFile + """ 128)"""))
        ...
        val typeInfoResp = interactor.sendRPCExp(30 seconds, SExpParser.read(
          """(swank:inspect-type-by-id 1)"""))
        ...
        // uses of symbol
        interactor.expectRPC(30 seconds, """(swank:uses-of-symbol-at-point """ + fooFile + """ 121)""",
          """(:ok ((:file """ + fooFile + """ :offset 114 :start 110 :end 172) (:file """ + fooFile + """ :offset 273 :start 269 :end 283)))"""
        )
        ...
        // M-. internal symbol
        val intSrc = config.cacheDir + "/dep-src/source-jars/scala/Int.scala"
        val stringSrc = config.cacheDir + "/dep-src/source-jars/java/lang/String.java"
        ...
        // M-.  external symbol
        val tuple2Src = config.cacheDir + "/dep-src/source-jars/scala/Tuple2.scala"
        val genMapFacSrc = config.cacheDir + "/dep-src/source-jars/scala/collection/generic/GenMapFactory.scala"
