...
object BigDecimalConvertor {
  ...
  implicit val IntBigConv: BigDecimalConvertor[Int] =
    new BigDecimalConvertor[Int](identity, _.intValue())
  implicit val LongBigConv: BigDecimalConvertor[Long] =
    new BigDecimalConvertor[Long](identity, _.longValue())
  implicit val FloatBigConv: BigDecimalConvertor[Float] =
  ...
  implicit val DoubleBigConv: BigDecimalConvertor[Double] =
  ...
  implicit val ByteBigConv: BigDecimalConvertor[Byte] =
    new BigDecimalConvertor[Byte](identity, _.byteValue())
  implicit val ShortBigConv: BigDecimalConvertor[Short] =
    new BigDecimalConvertor[Short](identity, _.shortValue())
  implicit val BigIntBigConv: BigDecimalConvertor[BigInt] =
    new BigDecimalConvertor[BigInt](BigDecimal.apply, _.toBigInt())
  implicit val BigDecimalBigConv: BigDecimalConvertor[BigDecimal] =
